...
void App_SystemPortConfig(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_1 | GPIO_Pin_3 | GPIO_Pin_4 | GPIO_Pin_5 | GPIO_Pin_6 | GPIO_Pin_8 | GPIO_Pin_9
	...
	//============================================================================
	//SPI LCD PortConfig
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_4|GPIO_Pin_9;		//CLK LCD_SDA2 LCD_CS
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_5;	//T_MISO&SDI2
