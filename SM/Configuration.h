...
//#define DEBUG_PRINTF	// printf debug define
//#define PID_DEBUG
...
#define DEFAULT_HEATER_TEMP 205
...
//#define DISABLE_Z 1
#define DISABLE_Z 0
#define DISABLE_E 1 // For all extruders
...
#define NUM_AXIS 4 // The axis order in all axis related arrays is X, Y, Z, E1, E2, E3
...
//========================================Add By Kim 20191229=============
//#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,400,94.4962144}  // default steps per unit for ultimaker 
#define DEFAULT_FEEDMULTIPLY	300
#define DEFAULT_MAX_FEEDMULTIPLY 500

#define DEFAULT_MAX_EXTRUDER_TEMP 230
#define DEFAULT_MIN_EXTRUDER_TEMP 180

//=====================================================================

#define DEFAULT_MAX_FEEDRATE          {500, 500, 40, 45}    // (mm/sec)                                            
//#define DEFAULT_MAX_FEEDRATE          {500,500, 12, 120}    // (mm/sec)                       
#define DEFAULT_MAX_ACCELERATION      {1200,1200,200,5000}     // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.


                                                                                                      
#define DEFAULT_ACCELERATION          700    // X, Y, Z and E max acceleration in mm/s^2 for printing moves

#define DEFAULT_RETRACT_ACCELERATION  700   // X, Y, Z and E max acceleration in mm/s^2 for r retracts                        
...
#define REPRINTSUPPORT	//上电续打宏定义
/*------------------------------------
 BED SETTINGS
 *------------------------------------*/

// Define Mesh Bed Leveling system to enable it
#define MESH_BED_LEVELING		//网格底板调平
#ifdef MESH_BED_LEVELING

#define MBL_Z_STEP 0.01

// Mesh definitions
#define MESH_MIN_X 4.2
#define MESH_MAX_X 159.2
#define MESH_MIN_Y 9.2
#define MESH_MAX_Y 154.2
...
//#define COREXY
#define MACHINE_MODE	2	//机器类型 1:儿童打印机 2：性价比机型
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,400,90}		//A4988
//#define DEFAULT_AXIS_STEPS_PER_UNIT   {640,640,400,90.0}			//LV8729
//#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,400,140}			//黄亚东那台挤出机值
