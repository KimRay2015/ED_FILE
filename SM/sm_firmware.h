...
extern u32 ReadPrintLine;
extern int printline;	//当前打印行数
extern u8 GoToLineFlg;
extern u8 NeedRePrintFlg;
extern u8 GCodeBuffer[128];
extern u8 filament_lack_flg;
extern float ZAxisValue;
