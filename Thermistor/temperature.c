...
//=============================public variables============================
//===========================================================================
int target_temperature[2] = { 0 };//EXTRUDERS
...
#define K2 (1.0-K1)
			...
			pid_output = constrain(pTerm[e] + iTerm[e] - dTerm[e], (target_temperature[e] - 10), PID_MAX);
		}
		#else
...
void tp_init()
{
	...
	TIM_TimeBaseStructure.TIM_Prescaler = 83;//8399;
	TIM_TimeBaseStructure.TIM_ClockDivision = TIM_CKD_DIV1;
	TIM_TimeBaseStructure.TIM_CounterMode = TIM_CounterMode_Up;
